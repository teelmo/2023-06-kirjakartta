...
function Map_Map(_ref) {
  ...
  var drawMarkers = (0,react.useCallback)(function (projection, svg) {
    ...
    svg.selectAll('.marker').data(data).enter().append('svg:path').attr('class', 'marker').attr('d', 'M0,0l-8.8-17.7C-12.1-24.3-7.4-32,0-32h0c7.4,0,12.1,7.7,8.8,14.3L0,0z').on('mouseover', function (event, d) {
      showTooltip(event, d);
