...
var getDataPath = function getDataPath() {
  ...
  if (true) return 'https://lusi-dataviz.ylestatic.fi/2022-11-miljoona_roskapussia/assets/data/2023-06-kirjakartta_map.tjson';
...
function Map_Map(_ref) {
  ...
  var drawMarkers = (0,react.useCallback)(function (projection, svg) {
    ...
    svg.selectAll('.text').data(data).enter().append('svg:text').attr('class', 'text').text(function (d) {
      return d.place;
    }).attr('transform', function (d) {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("h2", null, "L\xF6yd\xE4 kirja"), /*#__PURE__*/react.createElement("h4", null, "Valitse paikka"), /*#__PURE__*/react.createElement("div", {
    ...
    src: "./assets/img/".concat((_currentAreaData$plac = currentAreaData.place) === null || _currentAreaData$plac === void 0 ? void 0 : _currentAreaData$plac.toLowerCase(), "_viivapiirros.png"),
    alt: ""
  }), /*#__PURE__*/react.createElement("p", null, currentAreaData.text)), /*#__PURE__*/react.createElement("div", {
...
function App() {
  ...
  }, /*#__PURE__*/react.createElement("h2", null, "Kirjakartta"), data && /*#__PURE__*/react.createElement(components_Map, {
    data: data
